...
namespace Library.Utility
{
    public class UnityObjectPool<T> where T : Component
    {
        ...
        public UnityObjectPool(int capacity, Transform container = null)
        {
            ...
            Initialize(go.AddComponent<T>(), capacity, container);
        }

        private void Initialize(T prefab, int capacity, Transform container = null)
        {
            _prefab = prefab;
